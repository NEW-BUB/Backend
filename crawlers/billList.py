...
BILL_INFO_API_KEY = "tawUCzgIMfHMlfTzKESBWCS02sxs2XEUZARToOzLMJ2IROlKhLnRjT4R/E5sn+KHgppq3KrZjRVXVXL9yQ19VQ=="
INTEGRATED_BILL_INFO_API_KEY = "ee7ef6acc03a4b94bfdece6fd1721ed0"
...
if __name__ == "__main__":
    ...
    for i in range(2, 50):
        ...
        print("\n=== 외부 라이브러리 없이 키워드 추출 ===")
        keywords1 = keywords.get_keyword(text)
        for keyword, score in keywords1:
            print(f"{keyword}: {score}회")
        ...
        print("\n=== KKMA 키워드 추출 ===")
        keywords3 = keywords.extract_keywords_with_kkma(text, top_n=10)
